...
exports.Utilities = exports.Sync = exports.Hash = exports.Role = exports.OfflinePlugin = exports.User = exports.Import = exports.Translation = exports.Configuration = exports.ParallelSurvey = exports.Submission = exports.Pages = exports.Form = exports.Auth = exports.Connection = exports.GOAT = exports.Event = exports.Moment = exports.Schedule = undefined;
  ...
  return function (t) {
    ...
    (function (t) {
      Object.defineProperty(e, "__esModule", { value: !0 });var n = Object.assign || function (t) {
        ...
        return t && t.__esModule ? t : { default: t };
      }"undefined" != typeof navigator && navigator.product;var a,
          l,
          c,
          u,
          h,
            ...
            switch (t.prev = t.next) {case 0:
                if (f) {
                  ...
                  var e = void 0,
                    ...
                    "undefined" != typeof navigator && "ReactNative" == navigator.product ? (adapter = new (void 0)(), s = new i.default("GOAT", n({}, a, { adapter: adapter }))) : s = new i.default("GOAT", a);
                  }
                });case 3:
                f = t.sent;case 4:
    ...
    t.exports = function (t) {
      ...
      t.exports = function (t) {
        var e = typeof t === "undefined" ? "undefined" : _typeof(t);return Boolean(t) && ("object" === e || "function" === e);
      };
    }, function (t, e, r) {
      var n = r(5),
          i = r(3),
        ...
        return function () {
          ...
          var e = t.name,
            ...
            var e = [].concat(l(t));if (0 === this.orderByArray.length) return e;var r = this.orderByArray[0];if (this.selectArray.length > 0 && (r.includes(".") || r.includes("["))) throw new Error('Cannot orderBy nested attribute "' + r + '" when using Select. You must rename the attribute');var n = this.orderByArray[1],
                i = this.orderByArray[2];return i || (i = "string"), e = e.sort(function (t, e) {
      ...
      t.exports = function (t) {
        return Boolean(t) && "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && Object.getPrototypeOf(t) === Object.prototype;
      };
    }, function (t, e, r) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 });var n,
          i = r(12),
          o = (n = i) && n.__esModule ? n : { default: n };e.default = o.default.compose({ properties: { localFx: void 0, remoteFx: void 0 }, init: function init(t) {
          this.connectors = t;
...
!function (e, t) {
  ...
  return function (e) {
    ...
    e.exports = function (e) {
      ...
      var n = r(2),
        ...
        if (!u(e)) return e;var t = e.methods,
            ...
            j = d(s),
            M = {};return t && (M.methods = t), O && (M.properties = O), T && (M.initializers = T), j && (M.composers = j), _ && (M.deepProperties = _), A && (M.staticProperties = A), S && (M.staticDeepProperties = S), h && (M.propertyDescriptors = h), k && (M.staticPropertyDescriptors = k), P && (M.configuration = P), C && (M.deepConfiguration = C), M;
      }function h() {
        "use strict";
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });var n = i(r(38)),
      ...
      exports.default = _goatFluent.Interface.compose({
        methods: {
          ...
          httpGET: function httpGET() {
            ...
            return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
              var filter, url, headers, page, where, remotePath, isOnline;
              return regeneratorRuntime.wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                    ...
                    case 5:
                      ...
                      if (_this7.rawQuery) {
                        ...
                        filter.where = _extends({}, where, _this7.rawQuery.where);
                      }
                      ...
                      if (_this7.remoteConnection.path.includes("/")) {
                        _this7.remoteConnection.path = _this7.remoteConnection.path.replace("/", "");
                      }

                      // Looback replaces all singular words by plural

                      _this7.remoteConnection.path = (0, _pluralize2.default)(_this7.remoteConnection.path);
                      remotePath = _Utilities2.default.get(function () {
