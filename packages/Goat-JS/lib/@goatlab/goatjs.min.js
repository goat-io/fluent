        ...
        return function () {
          ...
          var t = Object.prototype.hasOwnProperty,
            ...
            if (0 === this.collection.data.length) return this.filteredrows = [], this.filterInitialized = !0, this;var i,
              ...
              if (x = this.filteredrows, A = x.length, b) for (o = o.split("."), P = 0; P < A; P++) {
                k = x[P], u(O[k], o, I, c) && v.push(k);
              } else for (P = 0; P < A; P++) {
                k = x[P], I(O[k][o], c) && v.push(k);
              }
            } else if (y) {
              var D = this.collection.calculateRange(l, o, c);if ("$in" !== l) {
                for (P = D[0]; P <= D[1]; P++) {
                  if (!0 !== p[l]) {
                    if (p[l](e.getIn(O[m.values[P]], o, b), c) && (v.push(m.values[P]), n)) return this.filteredrows = v, this.filterInitialized = !0, this;
            ...
            } else if (A = O.length, b) {
              for (o = o.split("."), P = 0; P < A; P++) {
                if (u(O[P], o, I, c) && (v.push(P), n)) return this.filteredrows = v, this.filterInitialized = !0, this;
              }
            } else for (P = 0; P < A; P++) {
              if (I(O[P][o], c) && (v.push(P), n)) return this.filteredrows = v, this.filterInitialized = !0, this;
            ...
            var o,
                ...
                h = "function" == typeof e,
                f = "function" == typeof r,
                d = {};if (l = this.data(i), o = l.length, t instanceof A) c = t.chain().data(i);else if (t instanceof O) c = t.data(i);else {
            ...
            this.keyMap = {}, this.lokiMap = {};
              ...
              this.index = {};
            } }, m.LokiOps = d, m.Collection = A, m.KeyValueStore = $, m.LokiMemoryAdapter = b, m.LokiPartitioningAdapter = w, m.LokiLocalStorageAdapter = I, m.LokiFsAdapter = x, m.persistenceAdapters = { fs: x, localStorage: I }, m.aeq = s, m.lt = a, m.gt = l, m.Comparators = o, m;
        }();
        ...
        return function (t) {
          ...
          var n = r(2),
            ...
            if (!a(t)) return t;var e = t.methods,
                ...
                P = a(d) ? c({}, d) : void 0;P = a(h) ? c(P, h) : P;var A = a(v) || a(y) ? u({}, v, y) : void 0,
                ...
                E = a(I) ? c({}, I) : void 0;E = a(x) ? c(E, x) : E;var C = f(o, i),
                j = f(l),
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }), e.Event = e.MergeConnector = e.Interface = e.Fluent = e.Model = void 0;var n = l(r(14)),
              i = l(r(9)),
              o = l(r(12)),
              s = l(r(20)),
              a = l(r(21));function l(t) {
            return t && t.__esModule ? t : { default: t };
          }e.Model = i.default, e.Fluent = n.default, e.Interface = o.default, e.MergeConnector = s.default, e.Event = a.default;
        }, function (t, e, r) {
          (function (t) {
        ...
        var t = "millisecond",
          ...
          var r = String(t);return !r || r.length >= e ? t : "" + Array(e + 1 - r.length).join(n) + t;
            ...
            var e = -t.utcOffset(),
                n = Math.abs(e),
                r = Math.floor(n / 60),
                i = n % 60;return (e <= 0 ? "+" : "-") + c(r, 2, "0") + ":" + c(i, 2, "0");
          }, m: function m(t, e) {
            var n = 12 * (e.year() - t.year()) + (e.month() - t.month()),
                r = t.clone().add(n, u),
                i = e - r < 0,
                s = t.clone().add(n + (i ? -1 : 1), u);return Number(-(n + (e - r) / (i ? r - s : s - r)) || 0);
          }, a: function a(t) {
            return t < 0 ? Math.ceil(t) || 0 : Math.floor(t);
          }, p: function p(h) {
            return { M: u, y: o, w: s, d: i, h: r, m: n, s: e, ms: t, Q: a }[h] || String(h || "").toLowerCase().replace(/s$/, "");
          }, u: function u(t) {
            return void 0 === t;
          } },
          ...
          return t instanceof v;
            ...
            M = function M(t, e, n) {
          var r;if (!t) return null;if ("string" == typeof t) m[t] && (r = t), e && (m[t] = e, r = t);else {
            var i = t.name;m[i] = t, r = i;
          }return n || (l = r), r;
        },
            D = function D(t, e, n) {
          if (y(t)) return t.clone();var r = e ? "string" == typeof e ? { format: e, pl: n } : e : {};return r.date = t, new v(r);
        },
            g = d;g.l = M, g.i = y, g.w = function (t, e) {
          ...
          function c(t) {
            ...
            this.$d = function (t) {
              var e = t.date,
                ...
                var r = e.match(h);if (r) return n ? new Date(Date.UTC(r[1], r[2] - 1, r[3] || 1, r[4] || 0, r[5] || 0, r[6] || 0, r[7] || 0)) : new Date(r[1], r[2] - 1, r[3] || 1, r[4] || 0, r[5] || 0, r[6] || 0, r[7] || 0);
              }return new Date(e);
            }(t), this.init();
          }, d.init = function () {
            ...
            var n = D(t);return this.startOf(e) <= n && n <= this.endOf(e);
            ...
            var h = this,
                ...
                c = g.p(t),
                d = function d(t, e) {
              var n = g.w(h.$u ? Date.UTC(h.$y, e, t) : new Date(h.$y, e, t), h);return f ? n : n.endOf(i);
            },
                $ = function $(t, e) {
              return g.w(h.toDate()[t].apply(h.toDate(), (f ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), h);
                ...
                var D = this.$locale().weekStart || 0,
                    v = (l < D ? l + 7 : l) - D;return d(f ? y - v : y + (6 - v), m);case i:case "date":
                return $(M + "Hours", 0);case r:
                return $(M + "Minutes", 1);case n:
                return $(M + "Seconds", 2);case e:
            ...
            var h,
                ...
                $ = f === i ? this.$D + (a - this.$W) : a;if (f === u || f === o) {
            ...
            var h,
                f = this;t = Number(t);var c = g.p(a),
                d = function d(e) {
              var n = new Date(f.$d);return n.setDate(n.getDate() + Math.round(e * t)), g.w(n, f);
            };if (c === u) return this.set(u, this.$M + t);if (c === o) return this.set(o, this.$y + t);if (c === i) return d(1);if (c === s) return d(7);var $ = (h = {}, h[n] = 6e4, h[r] = 36e5, h[e] = 1e3, h)[c] || 1,
                l = this.valueOf() + t * $;return g.w(l, this);
            ...
            var e = this;if (!this.isValid()) return "Invalid Date";var n = t || "YYYY-MM-DDTHH:mm:ssZ",
              ...
              var r = t < 12 ? "AM" : "PM";return n ? r.toLowerCase() : r;
                ...
                l = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: a + 1, MM: g.s(a + 1, 2, "0"), MMM: c(i.monthsShort, a, h, 3), MMMM: h[a] || h(this, n), D: this.$D, DD: g.s(this.$D, 2, "0"), d: this.$W, dd: c(i.weekdaysMin, this.$W, o, 2), ddd: c(i.weekdaysShort, this.$W, o, 3), dddd: o[this.$W], H: s, HH: g.s(s, 2, "0"), h: d(1), hh: d(2), a: $(s, u, !0), A: $(s, u, !1), m: u, mm: g.s(u, 2, "0"), s: this.$s, ss: g.s(this.$s, 2, "0"), SSS: g.s(this.$ms, 3, "0"), Z: r };return String(n.replace(f, function (t, e) {
            ...
            var c,
                ...
                m = this - $,
                y = g.m(this, $);return y = (c = {}, c[o] = y / 12, c[u] = y, c[a] = y / 3, c[s] = (m - l) / 6048e5, c[i] = (m - l) / 864e5, c[r] = m / 36e5, c[n] = m / 6e4, c[e] = m / 1e3, c)[d] || m, f ? y : g.a(y);
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });var n = Object.assign || function (e) {
      ...
      return function () {
        var t = e.apply(this, arguments);return new Promise(function (e, r) {
          ...
          var e = this;return p(regeneratorRuntime.mark(function t() {
          ...
          var t = this;return p(regeneratorRuntime.mark(function r() {
          ...
          var t = this;return p(regeneratorRuntime.mark(function r() {
            var u, s, c, f, l, d, p, h, m;return regeneratorRuntime.wrap(function (r) {
              for (;;) {
                switch (r.prev = r.next) {case 0:
                    if (Array.isArray(e)) {
                      r.next = 3;break;
                    ...
                    if (d = r.sent, p = o(d, 2), h = p[0], m = p[1], !h) {
                      r.next = 18;break;
            ...
            var n, o, i, u, s;return regeneratorRuntime.wrap(function (r) {
              for (;;) {
                switch (r.prev = r.next) {case 0:
                    ...
                    return u = i.components, s = t.getTableViewComponents(u), s = [].concat(d(s), ["id as _id", "modified as HumanUpdated"]), t.select(s), r.abrupt("return", t.paginate(e));case 12:case "end":
                    return r.stop();}
              }
            }, r, t);
          }))();
          ...
          var r = this;return p(regeneratorRuntime.mark(function e() {
        ...
        return function (e) {
          ...
          var n = r(2),
            ...
            if (!u(e)) return e;var t = e.methods,
                ...
                P = u(p) ? c({}, p) : void 0;P = u(l) ? c(P, l) : P;var O = u(v) || u(m) ? f({}, v, m) : void 0,
                ...
                j = u(E) ? c({}, E) : void 0;j = u(x) ? c(j, x) : j;var S = d(i, o),
                F = d(s),
...
var Schedule = function () {
  var _every = 0;
  every = function every(milliseconds) {
    _every = milliseconds;
    return undefined;
  };
  set = function () {
