...
```
*/
declare function isKyError(error: unknown): error is HTTPError | TimeoutError | ForceRetryError;
/**
...
export { type AfterResponseHook, type AfterResponseState, type BeforeErrorHook, type BeforeErrorState, type BeforeRequestHook, type BeforeRequestState, type BeforeRetryHook, type BeforeRetryState, ForceRetryError, HTTPError, type Hooks, type Input, type KyInstance, type KyRequest, type KyResponse, type NormalizedOptions, type Options, type Progress, type ResponsePromise, type RetryOptions, type SearchParamsOption, type ShouldRetryState, TimeoutError, ky as default, isForceRetryError, isHTTPError, isKyError, isTimeoutError };
