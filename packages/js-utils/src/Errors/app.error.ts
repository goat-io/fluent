 ...
 *
 * Reference: https://github.com/NaturalCycles/js-lib/blob/master/src/error/app.error.ts
 *
 * Based on: https://medium.com/@xpl/javascript-deriving-from-error-properly-8d2f8f315801
 */
export class AppError<DataType extends ErrorData = ErrorData> extends Error {
  data!: DataType

  constructor(message: string, data = {} as DataType) {
    super(message)
