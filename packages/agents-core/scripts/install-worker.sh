...
# ── Install package ──────────────────────────────────────────────────
echo ""
echo "Installing @goatlab/agents-core..."
npm install -g @goatlab/agents-core 2>/dev/null || {
  echo "WARN: Global install failed, trying local install..."
  npm install @goatlab/agents-core
}
echo "[OK] @goatlab/agents-core installed"
...
echo "    source $ENV_FILE && npx goat-agents-worker"
echo "======================================"
