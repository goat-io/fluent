import { mysqlTable, int, varchar, text, decimal, boolean, timestamp, mysqlEnum, index, uniqueIndex, primaryKey } from 'drizzle-orm/mysql-core'
...
export const categories = mysqlTable('categories', {
  ...
  parentId: int('parent_id').references(() => categories.id, { onDelete: 'set null' }),
...
export const reviews = mysqlTable('reviews', {
  ...
  createdAtIdx: index('idx_created_at').on(table.createdAt),
  userProductUnique: uniqueIndex('unique_user_product').on(table.userId, table.productId),
}))
