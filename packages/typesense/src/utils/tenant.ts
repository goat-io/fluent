 ...
 */
export function createFQCN(tenantId: string, baseCollectionName: string): string {
 ...
 */
export function parseFQCN(fqcn: string): { tenantId: string; baseCollectionName: string } | null {
 ...
 */
export function filterCollectionsByTenant(collections: string[], tenantId: string): string[] {
