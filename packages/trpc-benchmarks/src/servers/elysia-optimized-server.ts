...
const app = new Elysia()
  ...
  .group('/api/users', (app) =>
    app
      ...
      .get('/:id/orders', async ({ params, query }) => {
...
console.log(`[Elysia-Optimized+Bun+SQLite] Server running on http://localhost:${PORT}`)
console.log(`[Elysia-Optimized+Bun+SQLite] API endpoint: http://localhost:${PORT}/api`)
