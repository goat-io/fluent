...
export interface LinearClient {
  createIssue(req: { title: string; body: string; teamId: string; labels?: string[] }): Promise<{ id: string; identifier: string; url: string }>
  updateIssue(req: { issueId: string; title?: string; body?: string; status?: string }): Promise<{ id: string; identifier: string; url: string }>
