 ...
 */
const checkConditional = (component: any, row: any, data: any, recurse: boolean = false): any => {
  let isVisible = true
...
class Validator {
  ...
  private form: any
  private token: any
  constructor(form: any, model: any, token: any) {
    this.model = model
    this.async = []
    this.requests = {}
    this.form = form
   ...
   */
  buildSchema(schema: any, components: any, componentData: any, submission: any) {
    ...
    components.forEach((component: any) => {
      ...
      const isPersistent: any = !component.hasOwnProperty('persistent') || component.persistent
